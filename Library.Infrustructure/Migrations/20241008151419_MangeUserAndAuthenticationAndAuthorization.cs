...
{
    /// <inheritdoc />
    public partial class MangeUserAndAuthenticationAndAuthorization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Books__3DE0C2276D984D44", x => x.BookID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DefualtBorrrowDays = table.Column<byte>(type: "tinyint", nullable: false),
                    DefaultFinePerDay = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CCAC23B1124F", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookCopi__C26CCCE57EB9A8F4", x => x.CopyID);
                    table.ForeignKey(
                        name: "FK__BookCopie__BookI__398D8EEE",
                        column: x => x.BookID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Borrowin__D7C457FC843EDA3E", x => x.BorrowingRecordID);
                    table.ForeignKey(
                        name: "FK__Borrowing__CopyI__3F466844",
                        column: x => x.CopyID,
                        principalTable: "BookCopies",
                        principalColumn: "CopyID");
                    table.ForeignKey(
                        name: "FK__Borrowing__UserI__3E52440B",
                        column: x => x.UserID,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reservat__B7EE5F040DE82C50", x => x.ReservationID);
                    table.ForeignKey(
                        name: "FK__Reservati__CopyI__5070F446",
                        column: x => x.CopyID,
                        principalTable: "BookCopies",
                        principalColumn: "CopyID");
                    table.ForeignKey(
                        name: "FK__Reservati__UserI__4F7CD00D",
                        column: x => x.UserID,
                        principalTable: "User",
                        principalColumn: "UserID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Fines__9D4A9BCC946078AE", x => x.FineID);
                    table.ForeignKey(
                        name: "FK_Fines_BorrowingRecords",
                        column: x => x.BorrowingRecordID,
                        principalTable: "BorrowingRecords",
                        principalColumn: "BorrowingRecordID");
                    table.ForeignKey(
                        name: "FK__Fines__UserID__4222D4EF",
                        column: x => x.UserID,
                        principalTable: "User",
                        principalColumn: "UserID");
                });
